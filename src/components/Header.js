...
function Header() {
    ...
    return (
        <MainContainer isOpen={open} scrollDirection={scrollDirection} scrolledToTop={scrolledToTop}>
            <HeadContainer>
            <Logo isOpen={open}>Nishant Bhujbal</Logo>
            ...
            <Container id='navbar' isOpen={open}>
                ...
                <Resume>
                    <a href="https://drive.google.com/drive/u/0/folders/16o0bI7T1D_PARra5Y4gdWJsQnZ5nP5SA" target="_blank">Resume</a>
                </Resume>
